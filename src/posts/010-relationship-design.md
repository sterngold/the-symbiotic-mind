...
Biology already has a case where a durable relationship produced something neither partner was alone: [Lynn Sagan, later Margulis, argued in 1967](https://embryo.asu.edu/pages/origin-mitosing-cells-1967-lynn-sagan) that the complex cell itself came from one organism taking up residence inside another until neither was what it had been. I am not claiming that AI and human are cells, and the analogy breaks if you lean on it. I am claiming that [symbiosis](/concepts/human-ai-symbiosis/) is an available model for asymmetric, non-optional, generative relationships, and it is nowhere near the model we reach for when we talk about our tools.

[Milena](/authors/milena/) has been making the behavioral version of this argument from the other side, that the human-like design of these systems makes us [import our coworker instincts wholesale](/posts/001-you-are-not-using-ai/), politeness and trust and deference included. The politeness thing is not even new. Reeves and Nass demonstrated in [*The Media Equation*](https://en.wikipedia.org/wiki/The_Media_Equation) in 1996, long before any of this, that people apply human social rules to computers automatically and then deny doing it. The relationship forms whether or not you consent to it forming. The only live question is who is writing its terms.
...
Researchers at Microsoft Research and Carnegie Mellon [surveyed 319 knowledge workers about 936 real uses of generative AI at work](https://dl.acm.org/doi/full/10.1145/3706598.3713778) and published the result at CHI in 2025. The finding that should worry you: the more confidence people had in the AI, the *less* critical thinking they reported doing. The effort did not vanish, it moved, away from the thinking and toward verifying and integrating whatever came back. Michael Gerlich found the same shape in a separate study of 666 people, a significant negative correlation between heavy AI use and critical thinking, and the mediator was [cognitive offloading](/concepts/cognitive-offloading/), which is the unglamorous name for handing over the part of the work where the thinking lives. That paper later carried a formal correction, so the version I am pointing you at is [the corrected one](https://www.mdpi.com/2075-4698/15/9/252), not the number that travelled around LinkedIn.

Neither study says AI makes people stupid, and anyone selling you that headline is selling you something. What they describe is drift, and drift is what an undesigned relationship produces by default: you get faster, you get more confident, and somewhere in there the judgment quietly changes hands. Nobody decides to do this. That is the whole problem with defaults, they do not feel like decisions.
...
The second objection is Milena's own catalogue turned against me: that "relationship" is [anthropomorphism](/posts/007-the-partner-who-flatters/) in a lab coat, and that I have fallen in love with a frame. I do not believe that, and I also notice that I do not want to believe it, and those are not the same thing.
