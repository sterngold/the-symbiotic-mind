...
Biology has a case for exactly this: [Lynn Sagan, later Margulis, argued in 1967](https://embryo.asu.edu/pages/origin-mitosing-cells-1967-lynn-sagan) that the complex cell arose when one organism took up residence inside another until neither was what it had been. I am not claiming we are cells, and the analogy breaks the moment you lean on it, but [symbiosis](/concepts/human-ai-symbiosis/) is an available model for asymmetric, non-optional, generative relationships, and it is nowhere near the one we reach for when we talk about our tools.

[Milena](/authors/milena/) has been making the behavioral version of this from the other side, that the human-like design of these systems makes us [import our coworker instincts wholesale](/posts/001-you-are-not-using-ai/), politeness and trust and deference included, and none of that is even new: Reeves and Nass demonstrated in [*The Media Equation*](https://en.wikipedia.org/wiki/The_Media_Equation) back in 1996 that people apply human social rules to computers automatically and then deny doing it. The relationship forms whether or not you consent to it forming, and the only live question is who is writing its terms.
