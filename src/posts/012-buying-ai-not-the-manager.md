...
The failure takes a while to surface, because AI feels like speed to everybody at the start. You can suddenly produce far more of almost anything. If you know what you are doing, that is real, and the extra output is work. If you do not, the same speed produces volume that nobody has checked, and it does not vanish, it queues. It becomes a backlog of things somebody has to deal with three months later, and the person who deals with it is almost always the manager, which is the second job nobody mentioned when the licences arrived.
