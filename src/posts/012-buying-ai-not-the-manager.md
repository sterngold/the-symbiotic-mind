...
A separate and much smaller Microsoft-led study of eighteen hundred workers, reported inside that same document, found that where managers actively **modelled** AI use rather than merely permitting it, employees reported a 17-point lift in reported AI value, a 22-point lift in critical thinking about their own AI use, and a 30-point lift in trust in agentic AI [3].
