...
cover:
  ...
  alt: "A dusk river carries dozens of pale translucent leaf-like fragments downstream over a low stone weir; at the right edge a human hand reaches into the water and lifts a single fragment, and that one glows warm gold while all the others stay cold and drifting, an image of choosing what crosses the threshold to become memory."
ogImage: "/images/008-cover.png"
tags:
  - behavior
  - memory
...
1. Vlad Sterngold, *Down the Memory River with AI* (The Symbiotic Mind, Post 006). The companion piece on reconstructive AI memory and drift that this essay follows. https://symbiotic-mind.com/posts/006-down-the-memory-river/
2. The promotion boundary, the categorical gate, and the local-only choice described here are drawn from the author's own sovereign memory system, not a third-party product.
